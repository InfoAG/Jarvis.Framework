...
AbstractExpression::ExpressionP Modulo::executeExpression(Scope &scope, const LoadFunc &load, const PrintFunc &print, ExecOption execOption) const
{
...
bool Modulo::equals(const AbstractStatement *other) const
{
