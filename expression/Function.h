...
public:
    ...
    Function(std::string identifier, Operands arguments, std::vector<TypeInfo> argTypes) : AbstractLevelingOperation(std::move(arguments)), identifier(std::move(identifier)), argTypes(std::move(argTypes)) {}
